...
core_jobs = [ new Expando(jobName: "dev-${name}-public",
                   ...
                   new Expando(jobName: "dev-${name}-admin",
                          ...
                          traits: masterTraits,
                          startJob: true),
                          new Expando(jobName: "test-${name}-public",
                          displayName: "test-${name}-public",
                          owner: repoOwner,
                          repo: appRepoPublic,
                          credentialsId: githubCredentialsId,
                          ...
                          traits: masterTraits,
                          startJob: true),
                   new Expando(jobName: "test-${name}-api",
                          displayName: "test-${name}-api",
                          owner: repoOwner,
                          repo: appRepoApi,
                          credentialsId: githubCredentialsId,
                          jenkinsFilePath: "Jenkinsfile-test",
                          traits: masterTraits,
                          startJob: true),
                   new Expando(jobName: "test-${name}-admin",
                          displayName: "test-${name}-admin",
                          owner: repoOwner,
                          repo: appRepoAdmin,
                          credentialsId: githubCredentialsId,
                          jenkinsFilePath: "Jenkinsfile-test",
                          traits: masterTraits,
                          startJob: true),
                          new Expando(jobName: "master-${name}-public",
                          displayName: "master-${name}-public",
                          owner: repoOwner,
                          repo: appRepoPublic,
                          credentialsId: githubCredentialsId,
                          ...
                          traits: masterTraits,
                          startJob: true),
                   new Expando(jobName: "master-${name}-api",
                          displayName: "master-${name}-api",
                          owner: repoOwner,
                          repo: appRepoApi,
                          credentialsId: githubCredentialsId,
                          jenkinsFilePath: "Jenkinsfile-master",
                          traits: masterTraits,
                          startJob: true),
                   new Expando(jobName: "master-${name}-admin",
                          displayName: "master-${name}-admin",
                          owner: repoOwner,
                          repo: appRepoAdmin,
                          credentialsId: githubCredentialsId,
                          jenkinsFilePath: "Jenkinsfile-master",
